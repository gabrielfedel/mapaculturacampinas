            ...
            <ul class="bxslider">
                <?php foreach ($images as $image): ?>
                    <?php if ($imagesCount >=1): ?>
                        <li><a href="<?php echo url('/'); ?>files/original/<?php echo $image->filename; ?>" data-lightbox="gallery-name"><img src="<?php echo url('/'); ?>files/original/<?php echo $image->filename; ?>" height="200px"/></a></li>
                    <?php endif; ?>
