			...
			<?php 
				...
				if (stripos(get_current_record('file')->mime_type,'image') !== false) {
					...
					if (isset($dublin_files['Dublin Core']['Title']))
						$label_pic = $label_pic." ".$dublin_files['Dublin Core']['Title'][0]." <br/>";
					if (isset($dublin_files['Dublin Core']['Description']))
						$label_pic = $label_pic." ".$dublin_files['Dublin Core']['Description'][0]." <br/>";

					if (isset($dublin_files['Dublin Core']['Creator']))
						$label_pic = $label_pic." ".$dublin_files['Dublin Core']['Creator'][0]." <br/>";			
					if (isset($dublin_files['Dublin Core']['Date']))
						$label_pic = $label_pic." ".$dublin_files['Dublin Core']['Date'][0]." <br/>";							
					if (isset($dublin_files['Dublin Core']['Rights']))
						$label_pic = $label_pic." ".$dublin_files['Dublin Core']['Rights'][0]." <br/>";		
